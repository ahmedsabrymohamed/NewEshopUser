...
public class GridTrendAdapter extends RecyclerView.Adapter<GridTrendAdapter.GridViewHolder> {

    private final List<Product> products;
    private final  SetOncLickListener mListener;

    GridTrendAdapter(SetOncLickListener Listener){
    ...
    public GridViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View root=inflater.inflate(R.layout.grid_trend_item,parent,false);
...
//
    ...
    public class GridViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View view) {
            ...
            mListener.SetOnclickTrend(products.get(getAdapterPosition()));
    ...
    public interface SetOncLickListener{
        void SetOnclickTrend(Product product);
    }
